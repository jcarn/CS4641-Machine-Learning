...
# plot_method("Randomized Hill Climbing", "rhc")
# plot_method("Simulated Annealing", "sim_anneal")
# plot_method("Genetic Algorithms", "ga")
# plot_method("Backpropagation with Gradient Descent", "backprop")


# plot_method_notest("Traveling Salesman", "flipflop")
# plot_method_notest("Flip Flop", "flipflop")
plot_method_notest("Max K-Coloring", "maxk")
# plot_method_notest("4-Peaks", "4peaks")
