...
public class PokePrinter {
	...
	public static void printPolicyMap(List<State> states, Policy p, int maxHealth) {
...
//			int y = yValue.getDiscVal();
			...
			System.out.println("Health: " + curHealth + " Status: " + curStatus + " Action: " + action);
